"""Regression checks for the parity-rel-health-loom casebook."""
...
from casebook.harness import assert_expected, parity_rel_health_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(parity_rel_health_loom_summary(), assert_expected())
